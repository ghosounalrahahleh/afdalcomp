...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="col-md-4 d-flex align-items-center py-4">
      <a class="navbar-brand" href="index.html" style="font-family: 'Oldenburg', cursive;"><span
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item  submenu dropdown">
            ...
            <a href="{{ route('allCategories' )}}" class="nav-link dropdown-toggle">Companies</a>
          ...
          <li class="nav-item dropdown">
            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="../owner" role="button"
